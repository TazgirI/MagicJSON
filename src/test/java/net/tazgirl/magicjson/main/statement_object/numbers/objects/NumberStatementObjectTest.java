...
class NumberStatementObjectTest extends TestRoot
{
    ...
    void integerDefault()
    {
        Assertions.assertEquals(Integer.valueOf(0), DefaultValues.getDefault(Integer.class),getFunctionFail("integerDefault"));
    }

    @Test
    void floatDefault()
    {
        Assertions.assertEquals(Float.valueOf(0f), DefaultValues.getDefault(Float.class),getFunctionFail("floatDefault"));
    }

    @Test
    void doubleDefault()
    {
        Assertions.assertEquals(Double.valueOf(0.0d), DefaultValues.getDefault(Double.class), getFunctionFail("doubleDefault"));
    }

    @Test
    void longDefault()
    {
        Assertions.assertEquals(Long.valueOf(0L), DefaultValues.getDefault(Long.class), getFunctionFail("longDefault"));
    }

    @Test
    void integerDefaultResolve()
    {
        Assertions.assertEquals(emptyIntegerStatementObject.Resolve(), Integer.valueOf(0), getFunctionFail("integerDefaultResolve"));
    }

    @Test
    void floatDefaultResolve()
    {
        Assertions.assertEquals(emptyFloatStatementObject.Resolve(), Float.valueOf(0f),getFunctionFail("floatDefaultResolve"));
    }

    @Test
    void doubleDefaultResolve()
    {
        Assertions.assertEquals(emptyDoubleStatementObject.Resolve(), Double.valueOf(0.0d),getFunctionFail("doubleDefaultResolve"));
    }

    @Test
    void longDefaultResolve()
    {
        Assertions.assertEquals(emptyLongStatementObject.Resolve(), Long.valueOf(0L),getFunctionFail("longDefaultResolve"));
    }
