...
import net.tazgirl.magicjson.old.main.statement_object.BooleanStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.StringStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.numbers.objects.*;
