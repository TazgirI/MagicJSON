...
import net.tazgirl.magicjson.old.main.statement_object.compounds.and.AndBooleanStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.compounds.and.AndCompoundStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.compounds.and.AndNumericalStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.compounds.or.OrBooleanStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.compounds.or.OrNumericalStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.hook.HookParameterStatementObject;
import net.tazgirl.magicjson.old.main.statement_object.numbers.comparison_objects.LessThanStatementObject;
